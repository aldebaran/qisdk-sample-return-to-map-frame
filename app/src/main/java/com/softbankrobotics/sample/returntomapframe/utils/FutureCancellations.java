...
public final class FutureCancellations {
     ...
     */
    @NonNull
    public static Future<Void> cancel(@Nullable Future<?> futureToCancel) {
     ...
     */
    @NonNull
    public static Future<Void> cancelAll(@Nullable Future<?>... futuresToCancel) {
        ...
        for (Future<?> futureToCancel : futuresToCancel) {
            Future<Void> cancellation = cancel(futureToCancel);
